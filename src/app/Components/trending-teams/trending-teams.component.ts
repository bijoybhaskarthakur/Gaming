...
@Component({
  selector: 'app-trending-teams',
  templateUrl: './trending-teams.component.html',
  styleUrls: ['./trending-teams.component.scss']
})
export class TrendingTeamsComponent implements OnInit {
  items = [];
  ...
  getTrendingPLayerData() {
    ...
    // this.httpClient.get("assets/json/trendingTeams.json").subscribe(data => {
    //   console.log(data);
    //   this.trendingTeam = data;
    //   // this.products = data;
    // })
